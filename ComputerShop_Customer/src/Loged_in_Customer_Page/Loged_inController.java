 ...
 */
package Loged_in_Customer_Page;
 ...
 * @author MD SHAMIM
 */
public class Loged_inController implements Initializable {
    ...
    @FXML
    private void BuyNowButton(ActionEvent event) throws Exception {
//        SelectedProduct = ProductList.get(SelectedProductIndex).getModel();
        Alert alert = new Alert(AlertType.CONFIRMATION);
        alert.setHeaderText("Success");
        alert.setContentText("Successfully Buy " + SelectedProduct);
        alert.showAndWait();
    }
